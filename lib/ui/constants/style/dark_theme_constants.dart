...
class DarkThemeConstants extends UiConstantsManager {
  static final DarkThemeConstants instance = DarkThemeConstants._internal();

  factory DarkThemeConstants() {
    return instance;
  }

  DarkThemeConstants._internal();
  ...
  @override
  Color get colorScaffoldBackground => const Color(0xffF1F5F9);
  ...
  @override
  Color get colorInputDecorationHintStyleColor => const Color(0xffBDBDBD);

  @override
  Color get colorInputDecorationHintIconColor => Colors.grey;
  ...
  @override
  Color get colorDefaultTextButtonColor => const Color(0xff3E77F7);
  ...
  @override
  Color get colorQRScanBriefContainer => Colors.grey;
