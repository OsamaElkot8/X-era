...
class DefaultTextFieldErrorText extends StatelessWidget {
  final String text;
  const DefaultTextFieldErrorText({Key? key, required this.text})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<LocalSettingsBloc, LocalSettingsBlocState>(
      ...
      return Text(text,
          style: currentThemeModeConstants.textStyleDefaultTextFieldError
